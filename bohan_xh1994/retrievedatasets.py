...
class retrievedatasets(dml.Algorithm):
    ...
    reads = []
    writes = ['bohan_xh1994.crime_boston', 'bohan_xh1994.Food_Establishment_Inspections', 'bohan_xh1994.Entertainment_Licenses', 'bohan_xh1994.TRAFFIC_SIGNALS', 'bohan_xh1994.airbnb_rating','bohan_xh1994.Active_Food_Establishment_Licenses']
    ...
    def execute(trial = False):
        ...
        r = client.get("29yf-ye7n", limit=100)
        #r = json.loads(response_crime)
        #s = json.dumps(r, sort_keys=True, indent=2)
        repo.dropCollection("crime_boston")
        repo.createCollection("crime_boston")
        repo['bohan_xh1994.crime_boston'].insert_many(r)
        repo['bohan_xh1994.crime_boston'].metadata({'complete':True})
        #print(repo['bohan_xh1994.crime_boston'].metadata())
        ...
        repo['bohan_xh1994.property_boston_assessment_2014'].insert_many(r)'''
        ...
        repo['bohan_xh1994.Active_Food_Establishment_Licenses'].insert_many(r)
        ...
        client = sodapy.Socrata("data.cityofboston.gov", dml.auth['services']['cityofbostondataportal']['token'])
        r = client.get("cz6t-w69j", limit=100)
        s = json.dumps(r, sort_keys=True, indent=2)
        repo.dropCollection("Entertainment_Licenses")
        repo.createCollection("Entertainment_Licenses")
        repo['bohan_xh1994.Entertainment_Licenses'].insert_many(r)
        ...
        repo['bohan_xh1994.mbta_stop_by_location'].insert_many(r)'''
        ...
        repo['bohan_xh1994.TRAFFIC_SIGNALS'].insert(r)
        ...
        repo['bohan_xh1994.airbnb_rating'].insert(r)
        repo.logout()
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
            ...
            this_script = doc.agent('alg:bohan_xh1994#retrievedatasets', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})
            ...
            crime = doc.entity('dat:bohan_xh1994#crime', {prov.model.PROV_LABEL:'crime incident data', prov.model.PROV_TYPE:'ont:DataSet'})
            doc.wasAttributedTo(crime, this_script)
            doc.wasGeneratedBy(crime, get_crime, endTime)
            doc.wasDerivedFrom(crime, crime_resource, get_crime, get_crime, get_crime)

            foodEI = doc.entity('dat:bohan_xh1994#foodEI', {prov.model.PROV_LABEL:'food establishment inspection', prov.model.PROV_TYPE:'ont:DataSet'})
            ...
            AfoodEL = doc.entity('dat:bohan_xh1994#AfoodEL', {prov.model.PROV_LABEL:'Active Food Establishment Licenses', prov.model.PROV_TYPE:'ont:DataSet'})
            ...
            entertainmentL = doc.entity('dat:bohan_xh1994#entertainmentL', {prov.model.PROV_LABEL:'Entertainment License', prov.model.PROV_TYPE:'ont:DataSet'})
            ...
            traffic_signal = doc.entity('dat:bohan_xh1994#traffic_signal', {prov.model.PROV_LABEL:'Traffic Signal', prov.model.PROV_TYPE:'ont:DataSet'})
            ...
            airbnb_rating = doc.entity('dat:bohan_xh1994#airbnb_rating', {prov.model.PROV_LABEL:'Airbnb Rating', prov.model.PROV_TYPE:'ont:DataSet'})
