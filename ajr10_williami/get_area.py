...
class get_area(dml.Algorithm):
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        areas_cambridge_resource = doc.entity('awc:open_spaces_cambridge', {'prov:label':'ajr10_williami.area_spaces_cambridge, Service Requests', prov.model.PROV_TYPE:'ont:DataResource', 'ont:Extension':'json'})
        areas_boston_resource = doc.entity('awc:open_spaces_boston', {'prov:label':'ajr10_williami.area_spaces_boston, Service Requests', prov.model.PROV_TYPE:'ont:DataResource', 'ont:Extension':'json'})
