...
class property_2014(dml.Algorithm):
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        doc.usage(get_property_2014, resource, startTime, None,
                  ...
                  'ont:Query':'?type=Animal+property_2014&$select=type,latitude,longitude,OPEN_DT'
                  }
                  )

        property_2014 = doc.entity('dat:pt0713_silnuext#property_2014', {prov.model.PROV_LABEL:'Animals property_2014', prov.model.PROV_TYPE:'ont:DataSet'})
