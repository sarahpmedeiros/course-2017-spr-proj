...
class farmersmarkets(dml.Algorithm):
    ...
    reads = []
    writes = ['cxiao_jchew1_jguerero_mgarcia7.farmersmarkets']
    ...
    def execute(trial = False):
        ...
        repo['cxiao_jchew1_jguerero_mgarcia7.farmersmarkets'].insert_many(r)
        ...
        repo['cxiao_jchew1_jguerero_mgarcia7.farmersmarkets'].metadata({'complete':True})
        print(repo['cxiao_jchew1_jguerero_mgarcia7.farmersmarkets'].metadata())
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        this_script = doc.agent('alg:cxiao_jchew1_jguerero_mgarcia7#farmersmarkets', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})
        ...
        farmersmarkets = doc.entity('dat:cxiao_jchew1_jguerero_mgarcia7#farmersmarkets', {prov.model.PROV_LABEL:'farmersmarkets', prov.model.PROV_TYPE:'ont:DataSet'})
