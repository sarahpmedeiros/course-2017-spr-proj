...
class cornerstores(dml.Algorithm):
    ...
    reads = []
    writes = ['cxiao_jchew1_jguerero_mgarcia7.allcornerstores']
    ...
    def execute(trial = False):
        ...
        repo['cxiao_jchew1_jguerero_mgarcia7.allcornerstores'].insert_many(r)
        repo['cxiao_jchew1_jguerero_mgarcia7.allcornerstores'].metadata({'complete':True})
        print(repo['cxiao_jchew1_jguerero_mgarcia7.allcornerstores'].metadata())
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        this_script = doc.agent('alg:cxiao_jchew1_jguerero_mgarcia7#cornerstores', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})
        ...
        allcornerstores = doc.entity('dat:cxiao_jchew1_jguerero_mgarcia7#allcornerstores', {prov.model.PROV_LABEL:'Corner Stores in Boston', prov.model.PROV_TYPE:'ont:DataSet'})
