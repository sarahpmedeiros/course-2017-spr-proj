...
class supermarkets(dml.Algorithm):
    ...
    reads = []
    writes = ['cxiao_jchew1_jguerero_mgarcia7.supermarkets']
    ...
    def execute(trial = False):
        ...
        repo['cxiao_jchew1_jguerero_mgarcia7.supermarkets'].insert_many(r)
        repo['cxiao_jchew1_jguerero_mgarcia7.supermarkets'].metadata({'complete':True})
        print(repo['cxiao_jchew1_jguerero_mgarcia7.supermarkets'].metadata())
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        this_script = doc.agent('alg:cxiao_jchew1_jguerero_mgarcia7#supermarkets', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})
        ...
        supermarkets = doc.entity('dat:cxiao_jchew1_jguerero_mgarcia7#supermarkets', {prov.model.PROV_LABEL:'List of Supermarkets over 7000 sq ft in Boston', prov.model.PROV_TYPE:'ont:DataSet'})
