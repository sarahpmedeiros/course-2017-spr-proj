...
class example(dml.Algorithm):
    ...
    reads = []
    writes = ['mbyim_seanz.lost', 'mbyim_seanz.found']
    ...
    def execute(trial = False):
        ...
        repo['mbyim_seanz.lost'].insert_many(r)
        repo['mbyim_seanz.lost'].metadata({'complete':True})
        print(repo['mbyim_seanz.lost'].metadata())
        ...
        repo['mbyim_seanz.found'].insert_many(r)
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        this_script = doc.agent('alg:mbyim_seanz#example', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})
