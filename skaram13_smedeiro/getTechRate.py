...
class techRates(dml.Algorithm):
	...
	def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
		...
		techReport = doc.entity('dmg:skaram13_smedeiro#Technology-Report-by-State-by-District-by-School',{'prov:label':'Tech Report', prov.model.PROV_TYPE:'ont:DataSet','ont:Extension':'json'})		
		#this is the data set we create in this script
		techRates = doc.entity('dat:skaram13_smedeiro#techRates',{'prov:label':'The percentage of students for each computer in the classroom by org_code', prov.model.PROV_TYPE:'ont:DataSet','ont:Extension':'json'})
