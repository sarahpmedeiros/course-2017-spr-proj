...
class fetch_neighborhood_area_data(dml.Algorithm):
    ...
    reads = []
    writes = ['chamathd.neighborhood_area_boston', \
    ...
    def execute(trial = False):
        ...
        colName = "chamathd.neighborhood_area_boston"
        ...
        colName = "chamathd.neighborhood_area_cambridge"
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        this_script = doc.agent('alg:chamathd#fetch_neighborhood_area_data', {prov.model.PROV_TYPE:prov.model.PROV['SoftwareAgent'], 'ont:Extension':'py'})
        ...
        neighborhood_area_boston = doc.entity('dat:chamathd#neighborhood_area_boston', {prov.model.PROV_LABEL:'Boston Open Budget - Neighborhood Boundaries', prov.model.PROV_TYPE:'ont:DataSet'})
        ...
        neighborhood_area_cambridge = doc.entity('dat:chamathd#neighborhood_area_cambridge', {prov.model.PROV_LABEL:'Cambridge Neighborhood Polygons', prov.model.PROV_TYPE:'ont:DataSet'})
