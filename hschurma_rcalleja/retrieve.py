...
class retrieve(dml.Algorithm):
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        resource_g_rates = doc.entity('dat:hschurma_rcalleja/gradrates.json', {'prov:label':'BPS Graduation Rates', prov.model.PROV_TYPE:'ont:DataResource', 'ont:Extension':'json'})
