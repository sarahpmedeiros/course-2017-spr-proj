...
class retrieve(dml.Algorithm):
    ...
    def provenance(doc = prov.model.ProvDocument(), startTime = None, endTime = None):
        ...
        resource_SAT = doc.entity('bdp:wc8w-nujj', {'prov:label':'BPS SAT Scores', prov.model.PROV_TYPE:'ont:DataResource', 'ont:Extension':'json'})
        resource_g_rates = doc.entity('bdp:wc8w-nujj', {'prov:label':'BPS Graduation Rates', prov.model.PROV_TYPE:'ont:DataResource', 'ont:Extension':'json'})
        resource_fund = doc.entity('bdp:wc8w-nujj', {'prov:label':'BPS Funding', prov.model.PROV_TYPE:'ont:DataResource', 'ont:Extension':'json'})
